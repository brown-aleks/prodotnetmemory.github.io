...
![Рисунок 1-1](content/img/1-1.png) Рисунок 1-1. Компьютерная диаграмма с хранимой программой – память + указатель инструкций
...
![Рисунок 1-2](content/img/1-2.png) Рисунок 1-2. Операции извлечения и добавления стека. Это только концептуальный рисунок, не связанный с какой-либо конкретной моделью памяти и реализацией
...
![Рисунок 1-3a](content/img/1-3a.png) Рисунок 1-3a. Стек и области памяти кода – в момент перед вызовом функции fun1 из [листинга 1-2](<#l-1-2>)
...
![Рисунок 1-3b](content/img/1-3b.png) Рисунок 1-3b. Стек и области памяти кода – после вызова функции fun1 из [листинга 1-2](<#l-1-2>)
...
![Рисунок 1-3c](content/img/1-3c.png) Рисунок 1-3c. Стек и области памяти кода – в момент после вызова функции fun2 из fun1 
...
![Рисунок 1-4](content/img/1-4.png) Рисунок 1-4. Stack and code memory regions – after returning from function fun1, both activation frames are discarded
...
![Рисунок 1-5](content/img/1-5.png) Рисунок 1-5. Гипотетическая инструкция умножения в стековой машине — извлекает два элемента из стека и помещает результат их умножения в стек.
...
![Рисунок 1-6](content/img/1-6.png) Рисунок 1-6. Локальная переменная ptr функции, являющаяся указателем на память по адресу Addr
...
![Рисунок 1-7](content/img/1-7.png) Рисунок 1-7. Указатели, используемые для построения двусвязной структуры списка, когда каждый элемент указывает на свой предыдущий и следующий элементы.
...
![Рисунок 1-8](content/img/1-8.png) Рисунок 1-8. Стек с указателем ptr и блоком шириной 10 байт в куче
...
![Рисунок 1-9](content/img/1-9.png) Рисунок 1-9. Фрагментация – после удаления объектов B и D не остается достаточного смежного пространства для нового объекта X, хотя в целом для него достаточно свободного места.
...
![Рисунок 1-10](content/img/1-10.png) Рисунок 1-10. Достижимость – объекты C и F недостижимы, поскольку нет пути из корней (местоположений Мутатора), ведущего к ним.
...
Листинг 1-8. Пример псевдокода, иллюстрирующий подсчет ссылок ![Рисунок 1-11](content/img/1-11.png) Рисунок 1-11. Иллюстрация подсчета ссылок [листинга 1-8](<#l-1-8>)
...
![Рисунок 1-12](content/img/1-12.png) Рисунок 1-12. Проблема циклической ссылки при подсчете ссылок
...
![Рисунок 1-13-1](content/img/1-13-1.png) ![Рисунок 1-13-2](content/img/1-13-2.png) ![Рисунок 1-13-3](content/img/1-13-3.png) ![Рисунок 1-13-4](content/img/1-13-4.png) ![Рисунок 1-13-5](content/img/1-13-5.png) ![Рисунок 1-13-6](content/img/1-13-6.png) ![Рисунок 1-13-7](content/img/1-13-7.png) Рисунок 1-13. Пример фазы маркировки отслеживающего сборщика мусора
...
![Рисунок 1-14](content/img/1-14.png) Рисунок 1-14. Простая очистка – базовый способ
...
![Рисунок 1-15](content/img/1-15.png) Рисунок 1-15. Умная очистка – способ со списком свободных участков памяти
...
![Рисунок 1-16](content/img/1-16.png) Рисунок 1-16. Сборка компактизацией – реализация копирования
...
![Рисунок 1-17](content/img/1-17.png) Рисунок 1-17. Сборка компактизацией – реализация сжатия на месте
