...
```cpp title="listing-4-4.cpp" linenums="1"
...
```      
   ...
   <figcaption>Листинг 4-4. Причина утечки памяти в сценарии 4-2</figcaption>
</figure>
...
```csharp title="listing-4-5.cs" linenums="1"
...
```
   ...
   <figcaption>Листинг 4-5. Фрагмент проблемного кода для сценария 4-3</figcaption>
</figure>
