...
![Рисунок 4-2](content/img/4-2.png) Рисунок 4-2. Содержимое двоичного файла CoreCLR.HelloWorld.dll – результат компиляции программы из листинга 4-1   
...
![Рисунок 4-3](content/img/4-3.png) Рисунок 4-3. Несколько байтов, содержащих инструкции на общем промежуточном языке для метода Program.Main (стрелка добавлена ​​для ясности)
...
![Рисунок 4-4](content/img/4-4.png) Рисунок 4-4. Области памяти, показанные в инструменте VMMap для 64-разрядного приложения из [листинга 4-1](<#l-4-1>), работающего под управлением .NET 8.0   
...
![Рисунок 4-4a](content/img/4-4a.png)
...
![Рисунок 4-4b](content/img/4-4b.png)
...
![Рисунок 4-4c](content/img/4-4c.png)
...
![Рисунок 4-4d](content/img/4-4d.png)
...
![Рисунок 4-4e](content/img/4-4e.png)
...
![Рисунок 4-5](content/img/4-5.png) Рисунок 4-5. Диспетчер задач окна, показывающий основные данные об использовании памяти
...
![Рисунок 4-6](content/img/4-6.png) Рисунок 4-6. Счетчики производительности, показывающие основные данные об использовании памяти
...
![Рисунок 4-7](content/img/4-7.png) Рисунок 4-7. Использование dotnet-counters для просмотра рабочего набора и использования управляемой памяти
...
![Рисунок 4-8](content/img/4-8.png) Рисунок 4-8. Счетчики производительности для Сценария 4-2 показывают стабильный размер управляемой кучи, но приватный рабочий набор постоянно растет.
...
![Рисунок 4-9](content/img/4-9.png) Рисунок 4-9. Представление VMMap для областей памяти типа Heap в Сценарии 4-2. Постоянно растущие и периодически создаваемые области памяти Heap (Private Data).
...
![Рисунок 4-10](content/img/4-10.png) Рисунок 4-10. Анализ PerfView для сценария 4-2. Вы видите агрегированный стек вызовов для оператора new
...
![Рисунок 4-11](content/img/4-11.png) Рисунок 4-11. Вид VMMap процесса для сценария 4-3. Существует огромное количество виртуальной памяти (Size), но большая ее часть неиспользуемая. ![Рисунок 4-12](content/img/4-12.png) Рисунок 4-12. Вид VMMap Неиспользуемых регионов для Сценария 4-3. Существует много, много таких регионов, перемежающихся с частными данными размером в одну страницу.
...
![Рисунок 4-13](content/img/4-13.png) Рисунок 4-13. Анализ PerfView для сценария 4-3 показывает очень большое количество вызовов VirtualAlloc
...
![Рисунок 4-14](content/img/4-14.png) Рисунок 4-14. Анализ PerfView для сценария 4-3 показывает агрегированный стек вызовов для VirtualAlloc
...
![Рисунок 4-15](content/img/4-15.png) Рисунок 4-15. Вид VMMap управляемых куч для сценария 4-4
...
![Рисунок 4-16](content/img/4-16.png) Рисунок 4-16. Счетчики dotnet, отображающие огромное количество загруженных сборок и JIT-методов
...
![Рисунок 4-17](content/img/4-17.png) Рисунок 4-17. Вид событий PerfView для сценария 4-4. Вы видите много событий AssemblyLoad
...
![Рисунок 4-18](content/img/4-18.png) Рисунок 4-18. Представление трассировки стека PerfView для одного события AssemblyLoad указывает на конструктор XmlSerializer
